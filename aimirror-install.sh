...
npm install -y
cd
sudo mv config.js  /home/pi/AI-Mirror/
...
deactivate
sudo mv config.js /pi/AI-Mirror/config
sudo mv autostart /etc/xdg/lxsession/LXDE-pi
sudo mv hotword.py /pi/env/lib/python3.5/site-packages/googlesamples/assistant/library
